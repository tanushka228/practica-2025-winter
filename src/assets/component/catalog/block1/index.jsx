...
// import fotochka from '../../photo/fotochka.png'

// const Block1 = () => {
//   return (
//     <div className="w-full bg-[#171B1B] flex justify-center py-20 h-[517px]">
...
//           <button className=" cursor-pointer mt-10 px-10 py-4 bg-[#F2B766] h-16 w-[223px] text-[#171B1B] font-medium rounded-full text-[16px]">Start Searching </button>
//         </div>
