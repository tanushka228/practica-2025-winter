...
const Block1 = () => {
  const scrollToPopular = () => {
    const element = document.getElementById('popular-objects')
    if (element) {
    ...
    <div className="w-full bg-[#171B1B] flex justify-center py-20">
      <div className="w-[1200px] flex items-center justify-between gap-11">
        <div className="w-[50%] text-white">
          ...
          <button onClick={scrollToPopular} className="hover:bg-[#d99f4f] hover:scale-105 mt-10 px-10 py-4 bg-[#F2B766] h-16 w-[223px] text-[#171B1B] font-medium rounded-full text-[16px] transition-transform duration-200" >
            Start Searching
          </button>
        </div>
