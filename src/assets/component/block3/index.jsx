  ...
  return (
    <div className='bg-[#E3E3E3] w-[1440px] h-[910px] flex flex-col items-center pt-[60px]'>
      ...
      <div className='grid grid-cols-3 gap-[30px] px-[60px]'>
        ...
        <div className='bg-white rounded-[20px] p-[27px] w-[468px] h-[600px] justify-center items-center'>
        ...
        <div className='bg-[#1F1F1F] text-white rounded-[20px] p-[30px] w-[406px] h-[300px] ml-8'>
        ...
        <div className='bg-white rounded-[20px] p-[30px] w-[406px] h-[300px]'>
          <h2 className='text-[24px] font-semibold mb-[15px]'>
            Tailored Solutions for Every Client
          </h2>
        ...
        <div className='bg-white rounded-[20px] p-[30px] w-[406px] h-[270px] ml-[485px] mt-[-300px]'>
          <h2 className='text-[24px] font-semibold mb-[15px]'>
            Access to Exclusive Listings
          </h2>
        ...
        <div className='bg-[#1F1F1F] text-white rounded-[20px] p-[25px] w-[406px] h-[270px] ml-114 mt-[-300px]'>
          <h2 className='text-[24px] font-semibold mb-[15px]'>
            Reduced Sale and Purchase Timeframes
          </h2>
